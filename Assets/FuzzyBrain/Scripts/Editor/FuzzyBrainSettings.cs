...
namespace FuzzyBrain.Editor
{
    ...
    public class FuzzyBrainSettings : ScriptableObject
    {
        ...
        public string quickActScriptsFolder = "Assets/FuzzyBrain/Scripts/Acts";
        ...
        public static SettingsProvider CreateSettingsProvider()
        {
            return new SettingsProvider("Project/FuzzyBrain", SettingsScope.Project)
            {
                ...
                guiHandler = searchContext =>
                {
                    ...
                    EditorGUILayout.PropertyField(so.FindProperty("quickActScriptsFolder"),
                        new GUIContent("Quick Act Scripts"));
