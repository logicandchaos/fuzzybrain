...
/// </summary>
[CreateAssetMenu(fileName = "IsGrounded", menuName = "FuzzyBrain/Conditions/IsGrounded")]
public class OnGround : Condition<Collider2D>, IGizmoDrawable
{
    ...
    protected override bool Verify(Collider2D col)
    {
        ...
        bool grounded = Physics2D.Raycast(col.bounds.center, Vector2.down, rayLength, groundLayer);
    ...
    public void DrawGizmo(ActContext ctx)
    {
        ...
        float rayLength = col.bounds.extents.y + 0.1f;
        bool hit = Physics2D.Raycast(col.bounds.center, Vector2.down, rayLength, groundLayer);
